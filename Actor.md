...
- [ApplyLinearImpulse(float, float, float, float, bool)](./Actor-ApplyLinearImpulse(float_float_float_float_bool).md 'MuseDotNet.Framework.Actor.ApplyLinearImpulse(float, float, float, float, bool)')
- [ApplyRadialImpulse(MuseDotNet.Framework.Actor, float, float, bool)](./Actor-ApplyRadialImpulse(Actor_float_float_bool).md 'MuseDotNet.Framework.Actor.ApplyRadialImpulse(MuseDotNet.Framework.Actor, float, float, bool)')
- [ApplyVerticalImpulse(float)](./Actor-ApplyVerticalImpulse(float).md 'MuseDotNet.Framework.Actor.ApplyVerticalImpulse(float)')
...
- [LaunchActor(float, float, float, string)](./Actor-LaunchActor(float_float_float_string).md 'MuseDotNet.Framework.Actor.LaunchActor(float, float, float, string)')
- [MoveTo(MuseDotNet.Framework.Actor, float, bool, bool)](./Actor-MoveTo(Actor_float_bool_bool).md 'MuseDotNet.Framework.Actor.MoveTo(MuseDotNet.Framework.Actor, float, bool, bool)')
- [PerformJump(float, float)](./Actor-PerformJump(float_float).md 'MuseDotNet.Framework.Actor.PerformJump(float, float)')
- [PerformMultiJump(float, float)](./Actor-PerformMultiJump(float_float).md 'MuseDotNet.Framework.Actor.PerformMultiJump(float, float)')
- [QueueNextMovementMode(string, bool)](./Actor-QueueNextMovementMode(string_bool).md 'MuseDotNet.Framework.Actor.QueueNextMovementMode(string, bool)')
...
- [RemoveMovementMode(string)](./Actor-RemoveMovementMode(string).md 'MuseDotNet.Framework.Actor.RemoveMovementMode(string)')
