...
- [BeginHover(MuseDotNet.Framework.QuestData, float, float, float, int, int, int)](./Actor-BeginHover(QuestData_float_float_float_int_int_int).md 'MuseDotNet.Framework.Actor.BeginHover(MuseDotNet.Framework.QuestData, float, float, float, int, int, int)')
