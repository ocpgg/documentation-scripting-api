...
- [Update(MuseDotNet.Framework.Player, string, string, System.Nullable&lt;float&gt;, int, System.Nullable&lt;int&gt;, bool)](./QuestData-Update(Player_string_string_Nullable-float-_int_Nullable-int-_bool).md 'MuseDotNet.Framework.QuestData.Update(MuseDotNet.Framework.Player, string, string, System.Nullable&lt;float&gt;, int, System.Nullable&lt;int&gt;, bool)')
### Operators
